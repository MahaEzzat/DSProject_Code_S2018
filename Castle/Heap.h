...
//---------------------------------------
template <int const MAX_HEAP_SIZE>
void Heap<MAX_HEAP_SIZE>::ReheapDown(int root)
{
	int maxChild_index;
	int leftChild_index;
...
//---------------------------------------
template <int const MAX_HEAP_SIZE>
void Heap<MAX_HEAP_SIZE>::ReheapUp(int child_index)
{
	int parent_index;
	Enemy *temp;
	...
	if (size > root)
	{
		...
		if (Elements[parent_index]->GetPriority() < Elements[child_index]->GetPriority())
		{
			...
			m_Elements[parent_index] = m_Elements[child_index];
			m_Elements[child_index] = temp;
			// Make recursive call till reheaping completed
...
//---------------------------------------
template <int const MAX_HEAP_SIZE>
bool Heap<MAX_HEAP_SIZE>::Enqueue(Enemy *item)
{
...
//---------------------------------------
template <int const MAX_HEAP_SIZE>
Enemy *Heap<MAX_HEAP_SIZE>::Dequeue()
{
...
//---------------------------------------
template <int const MAX_HEAP_SIZE>
int Heap<MAX_HEAP_SIZE>::GetSize()
{
	return size;
}
...
//---------------------------------------
template <int const MAX_HEAP_SIZE>
void Heap<MAX_HEAP_SIZE>::printPriotity()
{
